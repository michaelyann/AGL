    ...
    <header class="header">
        ...
        <nav class="navigation">
            <ul>
                ...
                <li><a href="presidentjury.html">Gestion des Note</a></li>
                <li><a href="gestionplanning.html">Plannings</a></li>
                <li><a href="utlisateur.html">Administrateur et Utilisateur</a></li>
            </ul>
        ...
        <section class="hero-section">
            ...
            <div class="carousel">
                <div class="carousel-track">
                    ...
                    <div class="carousel-item"><img src="téléchargement.jpg" alt="Film 4"></div>
                </div>
